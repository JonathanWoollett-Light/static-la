...
impl<T: Add<Output = T> + Copy, const COLUMNS: usize> Add<MatrixDxS<T, COLUMNS>> for MatrixDxD<T> {
...
impl<T: Add<Output = T> + Copy, const ROWS: usize> Add<MatrixSxD<T, ROWS>> for MatrixDxD<T> {
...
impl<T: Add<Output = T> + Copy + Default, const ROWS: usize, const COLUMNS: usize>
    Add<MatrixSxS<T, ROWS, COLUMNS>> for MatrixDxD<T>
{
...
impl<T: Add<Output = T> + Copy + Default, const ROWS: usize, const COLUMNS: usize>
    Add<MatrixSxS<T, ROWS, COLUMNS>> for MatrixDxS<T, COLUMNS>
{
    type Output = MatrixSxS<T, ROWS, COLUMNS>;
    fn add(self, mut other: MatrixSxS<T, ROWS, COLUMNS>) -> Self::Output {
        assert_eq!(self.data.len(), ROWS, "Non-matching rows");
...
impl<T: Add<Output = T> + Copy, const ROWS: usize, const COLUMNS: usize>
    Add<MatrixSxS<T, ROWS, COLUMNS>> for MatrixSxD<T, ROWS>
{
    type Output = MatrixSxS<T, ROWS, COLUMNS>;
    fn add(self, mut other: MatrixSxS<T, ROWS, COLUMNS>) -> Self::Output {
        // We guarantee `other.data[0].len() == other.data[i].len()`.
